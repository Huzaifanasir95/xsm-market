...
echo "🚀 XSM Market - COMPLETE Backend Deployment ZIP"
echo "==============================================="
...
echo "📄 Copying complete backend..."
cp backend/server.js $DEPLOY_DIR/api/
...
echo ""
echo "🎉 COMPLETE BACKEND DEPLOYMENT READY!"
echo "====================================="
...
echo "npm install"
echo "pm2 stop xsm-api || true"
echo "pm2 delete xsm-api || true"
echo "npm run clean-db    # Clean database for fresh start"
echo "pm2 start server.js --name xsm-api"
echo "pm2 logs xsm-api    # Check logs"
echo ""
echo "🔥 NOW INCLUDES:"
echo "✅ Complete backend with all routes"
echo "✅ Authentication system"
echo "✅ User management"
echo "✅ Full ad management"
echo "✅ Google OAuth"
echo "✅ Email verification"
echo "✅ All controllers and middleware"
echo "✅ Database cleaning functionality"
echo ""
